...
// Coding in the Cabana by Coding Train
// My contribution
// 1. different way to add square contour
// 2. using for loops instead of switch for condition check
...
function setup() {
  ...
  button = createButton('switch solution')
  backgroundButton = createButton('switch background')
  
  button.size(220)
  backgroundButton.size(220)
  button.mousePressed(changeSolution)
...
function changeBackground(){
  backGroundColor = abs(255 - backGroundColor)
}
